...
1. Find out the target triple, e. g. `x86_64-unknown-linux-gnu`. For help, checkout https://github.com/japaric/rust-cross#the-target-triple
2. Add the toolchain: `rustup toolchain install stable-x86_64-unknown-linux-gnu`
3. Compile: `cargo build --target x86_64-unknown-linux-gnu`
